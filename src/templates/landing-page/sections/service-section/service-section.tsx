...
export default function ServiceSection() {
  ...
  return (
    <section id="servicos" className="py-20 bg-brand-50">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <p className="text-brand-600 mb-6 text-lg">
            ...
            <motion.button
              ...
              className="bg-brand-900 hover:bg-brand-800 text-white px-8 py-4 rounded-lg font-medium text-lg transition-colors"
            >
              Solicitar Orçamento
            </motion.button>
          </div>
